...
private:
	static void ParseMainHeaders(const std::string& top_headers, Email& out_email, Logger& logger);
	...
	static std::string ExtractFileName(const std::string& part_headers, Logger& logger);
};
